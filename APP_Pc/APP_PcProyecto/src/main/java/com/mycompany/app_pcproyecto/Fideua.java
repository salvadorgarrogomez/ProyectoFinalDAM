...
public class Fideua extends javax.swing.JDialog {
     ...
     */
    public Fideua(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingresar nuevo plato al menu de Fideúa:");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Fideua dialog = new Fideua(new javax.swing.JFrame(), true);
